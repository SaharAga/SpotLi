export const translations = {
  en: {
    ...
    tabs: {
      ...
      inTransit: 'In Transit',
      outForDelivery: 'Out for Delivery / Pickup',
      delivered: 'Delivered',
    ...
    filters: {
      ...
      expectedDate: 'Estimated Arrival',
      title: 'Item Title',
      status: 'Status',
      moreFilters: 'More filters & sorting options',
      gridView: 'Grid',
      tableView: 'Table',
      showArchived: 'Show Archived',
      clearFilters: 'Reset Filters',
      noPackages: 'No packages match your search or filter.'
    },
    card: {
    ...
    tracking: {
      ...
      notFound: 'No tracking record yet — {carrier} may not have scanned this package. Try again later, or update it manually.',
    ...
    detailModal: {
      ...
      noCheckpoints: 'No tracking updates recorded yet.',
      addCheckpointBtn: '+ Add Tracking Update',
      advanceStageBtn: 'Advance to Next Stage ➔',
      quickUpdate: 'Quick Stage Selector',
      checkpointModalTitle: 'Add Tracking Update',
      checkpointTitle: 'Event Title',
      checkpointTitlePlaceholder: 'e.g. Arrived at Sort Facility',
      checkpointLocation: 'Location',
      checkpointLocationPlaceholder: 'e.g. Modiin Logistics Center',
      checkpointDesc: 'Details',
      checkpointDescPlaceholder: 'e.g. Scanned and sorted for regional delivery',
      saveCheckpoint: 'Add Update'
    },
    smartModal: {
      title: 'Import from Message or Email',
      subtitle: 'Paste tracking text, SMS, or delivery notification to automatically fill package details.',
      pastePlaceholder: 'Paste SMS or email text here... Example:\n"שלום, דבר דואר שמספרו RS948219481IL נמסר לחלוקה בסניף דיזנגוף סנטר..."',
      parseBtn: 'Import Details',
      parsedSuccess: 'Successfully extracted shipping details! Review and confirm below:',
      noMatchAlert: 'Could not find a tracking number. Please check the text or enter details manually.'
    },
    deleteDialog: {
  ...
  he: {
    ...
    tracking: {
      ...
      notFound: 'אין עדיין רישום מעקב — ייתכן ש{carrier} טרם סרקו את החבילה. אפשר לנסות שוב מאוחר יותר או לעדכן ידנית.',
    ...
    detailModal: {
      ...
      timelineTitle: 'היסטוריית מעקב',
      noCheckpoints: 'טרם נרשמו עדכוני מעקב.',
      addCheckpointBtn: '+ הוסף עדכון מעקב',
      advanceStageBtn: 'קדם לשלב הבא ←',
      quickUpdate: 'עדכון סטטוס מהיר',
      checkpointModalTitle: 'הוספת עדכון מעקב',
      ...
      checkpointDesc: 'פירוט נוסף',
      checkpointDescPlaceholder: 'לדוגמה: החבילה נסרקה ונשלחה לחלוקה אזורית',
      saveCheckpoint: 'הוסף עדכון'
    },
    smartModal: {
      title: 'ייבוא מהודעה או אימייל',
      subtitle: 'הדבק הודעת SMS או אימייל שילוח למילוי אוטומטי של פרטי החבילה.',
      pastePlaceholder: 'הדבק כאן את תוכן ההודעה... לדוגמה:\n"שלום, דבר דואר שמספרו RS948219481IL נמסר לחלוקה בסניף דיזנגוף סנטר..."',
      parseBtn: 'ייבוא פרטים',
